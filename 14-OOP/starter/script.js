...
console.log(sourav.__proto__.__proto__);
console.log(sourav.__proto__.__proto__.__proto__);
...
const tesla = new EV('Tesla', 125, 23);
...
const acc1 = new Account('Sourav', 'INR', 1111);
