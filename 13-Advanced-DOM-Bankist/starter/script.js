...
document
  ...
  .addEventListener('click', function () {
    message.remove();
    // message.parentElement.removeChild(message);  // Old way of deleting elemnts
  });
...
// Do not use this way because it overrides all classes in that element to setted one
// logo.className = 'Sourav';
*/
